...
I created 2 databases and created tables with a primary key and datatypes. The tables in these databases contain customers personal information and customers oder details. I then created a relational database by joining the 2 tables to put all the customers personal and order details into one table to make it easier to view and retrieve data. 
